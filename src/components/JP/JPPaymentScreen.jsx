...
import OrderHistory from "/src/components/JP/JPOrderHistory";
import PaymentSuccess from "/src/components/JP/JPPaymentSuccess";
import KioskCountdownTimer from "/src/components/JP/JPKioskCountdownTimer";
    ...
    <ModalOverlay>
      <ModalContent>
        <div className="payment-screen">
          ...
          {isComplete && (
            <ButtonClose onClick={handleCompleteClose}>トジル</ButtonClose>
          )}
          {!isComplete && (
            <ButtonClose onClick={handleClose}>トジル</ButtonClose>
          )}
        </div>
      </ModalContent>
    </ModalOverlay>
